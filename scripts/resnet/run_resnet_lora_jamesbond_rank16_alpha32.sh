...
RUN_ROOT="${RUN_ROOT:-logs/resnet/resnet_lora_jamesbond_rank16_alpha32_${STAMP}}"
...
for seed in ${SEEDS}; do
  ...
  RUN_NAME="resnet_lora_jamesbond_r16_a32_seed_${seed}_${STAMP}"
