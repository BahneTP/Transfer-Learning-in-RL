...
RUN_ROOT="${RUN_ROOT:-logs/tl/dino_jamesbond_jepa_block3_weight_0p1_residual_${STAMP}}"
...
for seed in ${SEEDS}; do
  ...
  RUN_NAME="dino_jamesbond_jepa_block3_weight_0p1_residual_seed_${seed}_${STAMP}"
